...
resource "aws_api_gateway_domain_name" "domain_name" {
  ...
  #certificate_arn            = module.acm_module.aws_acm_certificate_validation.my-api_certificate_ARN
  #certificate_arn            = "arn:aws:acm:us-east-1:000000000000:certificate/60744047-a62a-4911-aa4f-9ce3328f60bd"
  domain_name                = "api.${var.root_domain_name}"
  regional_certificate_name  = "my-api-api"
...
resource "aws_api_gateway_domain_name" "domain_name" {
  domain_name               = "api.${var.root_domain_name}"
  regional_certificate_name = "my-api-api"
  certificate_arn           = module.acm_module.my-api_certificate_ARN
  endpoint_configuration {
    types = ["REGIONAL"]
  }
}
